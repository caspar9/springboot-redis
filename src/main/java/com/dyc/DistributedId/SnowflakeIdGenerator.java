...
public class SnowflakeIdGenerator implements IdGenerator<Long> {
     ...
     * 定义全局实例
     */
    public static final SnowflakeIdGenerator INSTANCE;

    /**
     * 静态块实例化,并随机生成datacenterId和workerId
     */
    static {
        int randomWorkerId = new Random().nextInt(62) + 1;
        int randomDatacenterId = new Random().nextInt(62) + 1;
        INSTANCE = new SnowflakeIdGenerator((long) randomWorkerId, (long) randomDatacenterId);
    }
     ...
     * @param datacenterId 数据中心ID (0~63)
     */
